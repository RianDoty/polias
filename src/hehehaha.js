javascript: (() => {
  function loadAnts() {
    ...
    var someFiles = [
      "//www.cs.huji.ac.il/~irush/scripts/jquery-1.6.1.min.js",
    ...
    switch (window.antsLoading) {
      ...
      case 1:
      case 2:
        if (window.antss !== undefined) break;
        document
          .getElementsByTagName("head")[0]
          .appendChild(document.createElement("script"))
          .setAttribute("src", protocol + someFiles[antsLoading]);
        break;
      case 3:
        $("body").highlight("a");
        $("body").highlight("e");
        ...
        break;
      default:
        if (antss.length > 0) new Ant(antss[0]);
        return;
    }
    window.antsLoading++;
